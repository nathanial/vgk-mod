                    ...
                    for (int h = 0; h < 8; ++h) {
                        ...
                        for (int x = 0; x < 4; ++x) {
                            ...
                            for (int z = 0; z < 4; ++z) {
                                index += maxheight;
                                if (height < 2) {
                                	primer.setBlockState(x, index, z, Blocks.BEDROCK.getDefaultState());
                                } else if ((d15 += d16) > 0.0D) {
                                	primer.setBlockState(x, index, z, Blocks.PLANKS.getDefaultState());
                                } else if (height < waterLevel) {
                                	primer.setBlockState(x, index, z, Blocks.LAVA.getDefaultState());
                                } else {
